srcdir = /home/damaleda/Escritorio/Archivos/descargas_Informix/PDO_INFORMIX-1.3.3
builddir = /home/damaleda/Escritorio/Archivos/descargas_Informix/PDO_INFORMIX-1.3.3
top_srcdir = /home/damaleda/Escritorio/Archivos/descargas_Informix/PDO_INFORMIX-1.3.3
top_builddir = /home/damaleda/Escritorio/Archivos/descargas_Informix/PDO_INFORMIX-1.3.3
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--with-pdo-informix=../../../../../../opt/IBM/Informix_Client-SDK'
CONFIGURE_OPTIONS = '--with-pdo-informix=../../../../../../opt/IBM/Informix_Client-SDK'
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
ZEND_EXT_TYPE = zend_extension
RE2C = exit 0;
AWK = nawk
shared_objects_pdo_informix = pdo_informix.lo informix_driver.lo informix_statement.lo
PHP_PECL_EXTENSION = pdo_informix
PDO_INFORMIX_SHARED_LIBADD = -Wl,-rpath,/opt/IBM/Informix_Client-SDK/lib/esql -L/opt/IBM/Informix_Client-SDK/lib/esql -Wl,-rpath,/opt/IBM/Informix_Client-SDK/lib/cli -L/opt/IBM/Informix_Client-SDK/lib/cli -Wl,-rpath,/opt/IBM/Informix_Client-SDK/lib -L/opt/IBM/Informix_Client-SDK/lib -lifcli -lifdmr
INFORMIXDIR = ../../../../../../opt/IBM/Informix_Client-SDK
IFX_LIBOBJS =
IFX_ESQL_FLAGS =
PHP_MODULES = $(phplibdir)/pdo_informix.la
PHP_ZEND_EX =
...
prefix = /usr
phplibdir = /home/damaleda/Escritorio/Archivos/descargas_Informix/PDO_INFORMIX-1.3.3/modules
...
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/usr/include/php/20180731 -I/usr/include/php/20180731/main -I/usr/include/php/20180731/TSRM -I/usr/include/php/20180731/Zend -I/usr/include/php/20180731/ext -I/usr/include/php/20180731/ext/date/lib -I/opt/IBM/Informix_Client-SDK/incl/cli -I/opt/IBM/Informix_Client-SDK/incl/esql
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
